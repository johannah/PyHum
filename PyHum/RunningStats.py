    ...
    def swig_import_helper():
        ...
        try:
            fp, pathname, description = imp.find_module(
                '_RunningStats', [dirname(__file__)])
        except ImportError:
        ...
        if fp is not None:
            try:
                _mod = imp.load_module(
                    '_RunningStats', fp, pathname, description)
            finally:
                fp.close()
            return _mod
...
class RunningStats(_object):
    ...
    def __setattr__(self, name, value): return _swig_setattr(
        self, RunningStats, name, value)
    __swig_getmethods__ = {}

    def __getattr__(self, name): return _swig_getattr(self, RunningStats, name)
    __repr__ = _swig_repr
    ...
    def NumDataValues(
        self): return _RunningStats.RunningStats_NumDataValues(self)
    ...
    def StandardDeviation(
        self): return _RunningStats.RunningStats_StandardDeviation(self)
    ...
    def __iadd__(
        self, *args): return _RunningStats.RunningStats___iadd__(self, *args)
