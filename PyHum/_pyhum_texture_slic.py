...
def texture_slic(humfile, sonpath, doplot=1, numclasses=4, maxscale=20, notes=4):
    ...
    if shape_port != '':
        ...
        #port_fp2 = pyhumio.get_mmap_data(sonpath, base, '_data_port_l.dat', 'float32', tuple(shape_port))
    ...
    if shape_star != '':
        ...
        #star_fp2 = pyhumio.get_mmap_data(sonpath, base, '_data_star_l.dat', 'float32', tuple(shape_star))
    ...
    for k in np.unique(segments_slic):
        ...
        tl[segments_slic == k] = parallel_me(
            cim, maxscale, notes, np.shape(cim)[0])
